                    ...
                    ->schema([
                        ...
                        Forms\Components\Placeholder::make('signature_status')
                            ...
                            ->content(function ($record) {
                                if (!$record) {
                                    return new HtmlString('<div class="text-gray-500">Surat belum dibuat</div>');
                                }

                                if ($record->approval_status === 'approved' && $record->signature_hash) {
                                    $signedDate = $record->signed_at?->format('d F Y H:i');
                                    return new HtmlString('<div class="p-3 bg-green-50 border border-green-200 rounded-lg">
                                ...
                                return new HtmlString('<div class="p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
